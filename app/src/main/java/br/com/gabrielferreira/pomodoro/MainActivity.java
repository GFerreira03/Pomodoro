...
public class MainActivity extends AppCompatActivity {
  ...
  private TextView pomodoroCountTxt;
  private TextView shortBreakTxt;
  private TextView longBreakTxt;
  private TextView pomodoroTxt;
      ...
      public void onClick(View view) {
        ...
        if (!isCounting) {
          ...
          if (!restTime) {
            ...
            startTimer();
            pomodoroCount += 1;
            pomodoroCountTxt.setText(String.format(Locale.getDefault(), "Pomodoros: %01d",
              pomodoroCount));
          ...
          Toast.makeText(getApplicationContext(), "Aguarde o término da contagem",
   ...
   *
   * @param res Recurso de áudio a ser iniciado.
   */
  ...
  private void createNotificationChannel() {
    NotificationChannel channel = new NotificationChannel("alarmNotification",
                                                        "alarm notification",
